...
def test_scoring_weights_sum_validation():
    ...
    sample_orders = [{"id": "L01", "total_weight_kg": 100.0, "total_volume_m3": 1.0, "total_value": 500.0}]
...
def test_scoring_edge_case_zero_capacities():
    ...
    sample_orders = [{"id": "L01", "total_weight_kg": 10.0, "total_volume_m3": 0.1, "total_value": 50.0}]
    with pytest.raises(ValueError, match="estritamente positivas"):
        calculate_order_scores(orders=sample_orders, capacity_kg=0.0, capacity_m3=10.0)
